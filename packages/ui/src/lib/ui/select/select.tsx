...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex min-h-[0.75rem] min-w-fit items-center justify-between rounded-md text-sm focus:outline-hidden focus:ring-2  disabled:cursor-not-allowed disabled:opacity-50',
      className,
    )}
    {...props}
  >
