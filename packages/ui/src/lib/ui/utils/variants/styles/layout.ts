...
// const overflowX: LayoutValueX<Overflow, 'overflow-x'> = {
...
// const overflowY: LayoutValueX<Overflow, 'overflow-y'> = {
...
// const overscroll: LayoutValueX<Overscroll, 'overscroll'> = {
//   auto: 'overscroll-auto',
//   contain: 'overscroll-contain',
//   none: 'overscroll-none',
// };

// const overscrollX: LayoutValueX<Overscroll, 'overscroll-x'> = {
//   auto: 'overscroll-x-auto',
//   contain: 'overscroll-x-contain',
//   none: 'overscroll-x-none',
// };

// const overscrollY: LayoutValueX<Overscroll, 'overscroll-y'> = {
...
/*!
  // Base variants
  inline block inline-block flow-root flex inline-grid contents table inline-table table-caption table-cell table-column table-column-group table-footer-group table-header-group table-row-group table-row list-item hidden sr-only not-sr-only
  ...
  // Responsive variants
  sm:inline sm:block sm:inline-block sm:flow-root sm:flex sm:inline-grid sm:contents sm:table sm:inline-table sm:table-caption sm:table-cell sm:table-column sm:table-column-group sm:table-footer-group sm:table-header-group sm:table-row-group sm:table-row sm:list-item sm:hidden sm:sr-only sm:not-sr-only
  ...
  lg:inline lg:block lg:inline-block lg:flow-root lg:flex lg:inline-grid lg:contents lg:table lg:inline-table lg:table-caption lg:table-cell lg:table-column lg:table-column-group lg:table-footer-group lg:table-header-group lg:table-row-group lg:table-row lg:list-item lg:hidden lg:sr-only lg:not-sr-only
  ...
  xl:inline xl:block xl:inline-block xl:flow-root xl:flex xl:inline-grid xl:contents xl:table xl:inline-table xl:table-caption xl:table-cell xl:table-column xl:table-column-group xl:table-footer-group xl:table-header-group xl:table-row-group xl:table-row xl:list-item xl:hidden xl:sr-only xl:not-sr-only
  ...
  2xl:inline 2xl:block 2xl:inline-block 2xl:flow-root 2xl:flex 2xl:inline-grid 2xl:contents 2xl:table 2xl:inline-table 2xl:table-caption 2xl:table-cell 2xl:table-column 2xl:table-column-group 2xl:table-footer-group 2xl:table-header-group 2xl:table-row-group 2xl:table-row 2xl:list-item 2xl:hidden 2xl:sr-only 2xl:not-sr-only
