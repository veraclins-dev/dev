...
import { type Notification, type User } from '#app/utils/db/types';
import { type NotificationInput, type UpdateNotificationInput } from '#app/utils/notifications/types';
