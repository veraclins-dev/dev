# Testing the @veraclins-dev/starter-nx Generator
...
- Access to the `@veraclins-dev/starter-nx` package (published or local)
...
```bash
pnpm add -D @veraclins-dev/starter-nx@latest
```
...
pnpm add -D @veraclins-dev/starter-nx@workspace:*

# Or if testing from veraclins-dev workspace:
pnpm link /path/to/veraclins-dev/dist/packages/starter-nx
```
...
```bash
nx g @veraclins-dev/starter-nx:app my-test-app
```
...
```bash
nx g @veraclins-dev/starter-nx:app my-test-app --interactive
```
...
```bash
nx g @veraclins-dev/starter-nx:app minimal-app \
  --features= \
  --emailProvider=none \
...
```bash
nx g @veraclins-dev/starter-nx:app full-app \
...
```bash
nx g @veraclins-dev/starter-nx:app deps-test \
...
```bash
nx g @veraclins-dev/starter-nx:app sqlite-app \
  --database=sqlite
```
...
```bash
nx g @veraclins-dev/starter-nx:app providers-test \
...
pnpm list @veraclins-dev/starter-nx

# Check if package is in node_modules
ls node_modules/@veraclins-dev/starter-nx
```
