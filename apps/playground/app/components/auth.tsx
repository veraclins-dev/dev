...
import {
  ...
  Google,
  Twitter,
} from '@veraclins-dev/remix-auth-social';
import {
  Badge,
  Box,
  Button,
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Remix Auth Social provides OAuth2 authentication strategies for
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold">Exchange code for tokens</h4>
                    <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-4 p-4 border rounded-lg">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline">{mockUserProfile.provider}</Badge>
                  </div>
