...
// Import only the actual available utilities
import {
  // Date utilities
  addHours,
  breakpoints,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Box className="p-4 border rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div>
                      <strong>formatAsDate:</strong> {formatAsDate(new Date())}
                    </div>
                    <div>
                    ...
                    <div>
                      <strong>formatAsTime:</strong> {formatAsTime(new Date())}
                    </div>
                    <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Box className="p-4 border rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      <strong>getErrorMessage:</strong> Extracts error messages
                    </div>
                    <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Box className="p-4 border rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      <strong>toNumber('123.45'):</strong> {toNumber('123.45')}
                    </div>
                  </div>
                </Box>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Box className="p-4 border rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  <strong>Meta Description:</strong> {truncate(sampleText, 50)}
                </div>
                <div>
