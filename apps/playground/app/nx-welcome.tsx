...
import { Editor, EditorReadonly } from '@veraclins-dev/editor';
...
export function NxWelcome({ title }: { title: string }) {
  const [formValue, setFormValue] = useState<string>(exampleContent);
    ...
    @media screen and (min-width: 768px) {
      ...
      <div className="wrapper">
        <div className="container">
          ...
          <LabeledTextarea label="An input" className="border mb-4" />
          ...
          <EditorReadonly content={formValue} mentionPath={mentionPath} />
