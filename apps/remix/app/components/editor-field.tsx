...
import { Editor } from '@veraclins-dev/editor';
...
type EditorProps = Omit<TextareaFieldProps, 'value'> & {
  value?: string;
};

export const EditorField = forwardRef<HTMLDivElement, EditorProps>(
  (
    {
      onChange,
      label,
        ...
        <ClientOnly
          fallback={
            <TextareaField
              ...
              className={cn('w-full border', bgClass)}
            />
          }
        >
          {() => (
